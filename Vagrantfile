Vagrant.configure("2") do |config|
  ...
  config.vm.define "k8s-master" do |k8s_master|
    ...
    k8s_master.vm.network "private_network", type: "static", ip: "192.168.10.93"
  ...
  config.vm.define "k8s-node-1" do |k8s_node_1|
    ...
    k8s_node_1.vm.network "private_network", type: "static", ip: "192.168.10.94"
  ...
  config.vm.define "windows" do |windows|
    ...
    windows.vm.network "private_network", type: "static", ip: "192.168.10.89"
